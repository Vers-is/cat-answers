...
const answers = [
    ...
    { text: "Ну конечно, даже не сомневайся!", mood: "very_yes" },
    { text: "Печенька говорит 'да', значит так и будет!", mood: "very_yes" },
    { text: "Тут могла бы быть ваша реклама!", mood: "absolute_yes" },
    { text: "Нетушки!", mood: "no" },
    { text: "Заходит как то улитка в бар...", mood: "absolute_yes" },
    { text: "А за ушком мне почешешь?", mood: "very_yes" },
    { text: "Разбирайся сам :3", mood: "no" },
    { text: "Я уверена, что да!", mood: "yes" },
    { text: "Я уверена, что нет.", mood: "no" },
    { text: "Посмотрим", mood: "very_yes" },
    { text: "Не-не", mood: "no" },
    { text: "Ответ у тебя за спиной… ага, попался!", mood: "absolute_yes" },
    { text: "Твой вопрррос услышан. Мы обязательно обсудим его в Совете Котят.", mood: "very_ves" },
    { text: "У меня сейчас обед, иди погуляй!", mood: "very_no" },
    { text: "Точняк!", mood: "very_yes" },
    { text: "Нетушки!", mood: "absolute_no" },
    { text: "Ноль шансов", mood: "absolute_no" },
    { text: "Не-е-ет! Уррржасно!", mood: "absolute_no" }, 
    { text: "Конечно, даже котики это знают!", mood: "very_yes" },
    { text: "Ты и сам знаешь ответ.", mood: "yes" },
    { text: "Ты еще не готов к ответу.", mood: "very_no" },
    { text: "Ответ отрицательный", mood: "very_yes" },
    { text: "По фэншую", mood: "very_yes" },
